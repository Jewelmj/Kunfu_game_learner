...
N_ENVS = 10                # number of parelel enviorments
...
# --- Agent select ---
AGENT_TYPE = 'DQN' # Options: 'DQN', 'LINEAR'
...
CONV_KERNELS = [8, 4, 3]
CONV_STRIDEs = [4, 2, 1]
FC_UNITS1 = 512   # common for DQN and linier model.
FC_UNITS2 = 512   # common for DQN and linier model.
...
LOG_CURRENT_BEST_MODEL_AS = "saved_models/best_kungfu_dqn_"
LOG_FINAL_BEST_MODEL_AS = "saved_models/kungfu_dqn_final"
